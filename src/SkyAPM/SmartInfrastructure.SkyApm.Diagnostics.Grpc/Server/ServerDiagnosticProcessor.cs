...
namespace SmartInfrastructure.SkyApm.Diagnostics.Grpc.Server
{
    public class ServerDiagnosticProcessor
    {
        ...
        public void BeginRequest(ServerCallContext grpcContext)
        {
            ...
            context.Span.Component = new StringOrIntValue("GRPC"); 
            context.Span.Peer = new StringOrIntValue(grpcContext.Peer);
            context.Span.AddTag("grpc.method", grpcContext.Method);
            context.Span.AddLog(
        ...
        public void EndRequest(ServerCallContext grpcContext)
        {
            ...
            context.Span.AddTag("grpc.status", statusCode.ToString());
            context.Span.AddLog(
